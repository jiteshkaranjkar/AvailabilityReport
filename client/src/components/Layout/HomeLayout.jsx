    ...
    render() {
        ...
        <div>
            ...
            <Row className="show-grid text-center">
                    ...
                    <Paper className={classes.paper}>
                        ...
                        <OverlayTrigger overlay={employeePopOver}>
                            <Panel bsStyle="primary" className={classes.root}>
                                <Panel.Body>
                                    <Typography variant="display3" style={styles.numbers} gutterBottom>
                ...
                <Col xs={12} sm={3} className="person-wrapper">
                {/* <div id="my-panel" className="panel panel-primary" >
                    <div id="panel-body" className="panel-body" >
                        <p >{9}</p>
                    </div>
                    <div id="panel-header" className="panel-heading" >Service Areas</div>
                </div> */}
                    <Paper className={classes.paper}>
                        <Panel bsStyle="primary" className={classes.root}>
                            <Panel.Body>
      ...
      <GridItem xs={12} sm={12} md={6}>
          <Card>
            <CardHeader color="warning" stats icon>
              ...
              <large>{this.props.numbers.employeesCount}+ </large>
              </h2>
            </CardHeader>
            <CardFooter stats>
...
HomeLayout.propTypes = {
  ...
  export default withStyles(dashboardStyle, styles)(HomeLayout);